...
% Margens estilo IEEE (aprox. 17.8cm x 24.7cm area de texto)
\setlength{\oddsidemargin}{-0.04cm}   % ~2cm esquerda
\setlength{\evensidemargin}{-0.04cm}
\setlength{\topmargin}{-1.0cm}
\setlength{\headheight}{12pt}
\setlength{\headsep}{0.35cm}
\setlength{\textwidth}{17.8cm}        % 21cm - 2x1.6cm
\setlength{\textheight}{24.7cm}
\setlength{\columnsep}{0.6cm}

% Espacamento simples (estilo IEEE)
\renewcommand{\baselinestretch}{1.0}

% Notas de fonte abaixo de figuras/tabelas
\newcommand{\legend}[1]{\par\vspace{2pt}\footnotesize #1}
% Citacao no estilo autor(2021)
\newcommand{\citeonline}[1]{\citeauthor{#1} (\citeyear{#1})}
\newcommand{\unbblue}{RoyalBlue}
\hypersetup{pdftitle={Projeto e Simulacao de um Ressonador Omega de Micro-ondas},
            pdfsubject={Relatorio Tecnico de Projeto -- Universidade de Brasilia},
            pdfauthor={J. V. V. Faria, T. Ferreira},
            pdfkeywords={ODMR, centros NV, ressonador omega, micro-ondas, UnB}}

% Pagestyle IEEE (sem cabecalho, pagina centralizada no rodape)
\makeatletter
\def\ps@ieee{
  \let\@oddhead\@empty
  \let\@evenhead\@empty
...
% --- Titulo e autores no estilo IEEE ---
\twocolumn[
\begin{center}
\vspace*{0.3cm}
...
{\normalsize
\textbf{Jo\~ao Victor Vieira Faria} \quad e \quad \textbf{Thiago Ferreira}\par}
\vspace{0.15cm}
{\small\itshape
Departamento de Engenharia El\'etrica (ENE) -- Faculdade de Tecnologia\\
Universidade de Bras\'ilia (UnB), Bras\'ilia, DF, Brasil\par}
\vspace{0.15cm}
{\small Orientador: Prof.\ Dr.\ Achiles Fontana da Mota\par}
\vspace{0.5cm}
\end{center}
]
\setcounter{page}{1}
...
\begin{figure}[htb]
	...
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_planta_baixa.png}
...
\begin{figure}[htb]
	...
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_detalhe_abertura.png}
...
\begin{figure}[htb]
	...
	\label{fig:stackup}
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_stackup_lateral.png}
	\legend{Fonte: elaborado pelo autor.}
\end{figure}
...
\begin{figure}[htb]
	...
	\label{fig:hfss-iso}
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_hfss_isometrica.png}
...
\begin{figure}[htb]
	...
	\label{fig:hfss-top}
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_hfss_topo.png}
	\legend{Fonte: Ansys HFSS 2025~R2 Student, modelo simulado.}
\end{figure}
...
\begin{figure}[htb]
	...
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_3d_estrutura_completa.png}
...
\begin{figure}[htb]
	...
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_3d_detalhe_abertura.png}
...
\begin{figure}[htb]
	...
	\label{fig:s11}
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_S11.png}
...
\begin{figure}[htb]
	...
	\label{fig:s21}
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_S21.png}
	\legend{Fonte: elaborado pelo autor, dados do Ansys HFSS.}
\end{figure}
...
\begin{figure}[htb]
	...
	\label{fig:delta}
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_delta_diamante.png}
	\legend{Fonte: elaborado pelo autor, dados do Ansys HFSS.}
\end{figure}
...
\begin{figure}[htb]
	...
	\label{fig:campo}
	\centering
	\includegraphics[width=\columnwidth]{../results/figures/fig_campo_MagH_cortes.png}
	\legend{Fonte: elaborado pelo autor, dados do Ansys HFSS.}
\end{figure}
